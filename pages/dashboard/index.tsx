    ...
    return (
        <div>
            <div className="flex h-screen bg-gray-200">
                <div className="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-dark-red overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
                    ...
                    <header className="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-indigo-600">
                        <div className="flex items-center">
                            ...
                            <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4 6H20M4 12H20M4 18H11" stroke="#000000" stroke-width="2" stroke-linecap="round"
