    ...
    return (
        <Layout>
            <div className="container mx-auto px-6 py-8">
                ...
                <h3 className="text-pink text-3xl text-center font-medium">Reagendar cita</h3>
                                ...
                                <tbody className="bg-white">
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <button className="text-dark-red" onClick={() => showAlert('Será redigirido a la página de crear una nueva cita')}>
                                                Reagendar
                                                <a href='/new/index'></a>
                                            </button>
                                        </td>
